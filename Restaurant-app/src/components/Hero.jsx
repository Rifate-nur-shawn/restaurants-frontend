          ...
          <div className="w-auto py-2 px-4 m-20 md:px-12 bg-white">
            <div className="max-w-7xl text-center mx-auto mb-7">
              ...
              <div className="text-center  mb-3 "></div>
                <h3 className="text-3xl font-bold text-gray-800 mb-2">Foodie Favourites!</h3>
                <p className="text-gray-600 text-lg">Get to know our top picks and hidden gems!</p>
              </div>
              ...
              <div className="relative">
                ...
                >
                  ...
                  {[
                    ...
                    <div key={index} className="flex-shrink-0 w-full sm:w-1/2 md:w-1/4 px-3">
